 ...
 * 
 */
if (!dojo._hasResource["brainyit.ui.customer.pf.delete.DeletePFCustomerUI"]) {
	dojo._hasResource["brainyit.ui.customer.pf.delete.DeletePFCustomerUI"] = true;
	dojo.provide("brainyit.ui.customer.pf.delete.DeletePFCustomerUI");
	dojo.declare(
	    "brainyit.ui.customer.pf.delete.DeletePFCustomerUI",null,
	    {
